...
class Command:
    ...
    Root class used for define new mloq commands. It establishes the
    fundamental methods to run and update the configuration values used
    to create the necessary files for your project, while registering the
    latter for later use.
    ...
    Attributes of this class:
        ...
        directories: Tuple containing Paths objects describing the
            directories that will be created by mloq.
    ...
    def record(self) -> CMDRecord:
        """CMDRecord instance. Keep track of files and directories generated by mloq."""
        return self._record
    ...
    def parse_config(self) -> DictConfig:
        """
        Update the configuration dictionary from the incoming values.

        Given the basic configuration contained in mloq.yml, this method
        updates the values of those parameters (included in CONFIG object)
        that are related to the selected command. Incoming values are
        introduced either interactively or via a custom user's mloq.yml
        file.

        Returns:
             It returns an updated version of the 'config' attribute
                included within the 'record' instance.
        """
    ...
    def interactive_config(self) -> DictConfig:
        """Pase user's configuration interactively."""
    ...
    def configure(self) -> None:
        ...
        this method calls the 'update_config' function, which registers
        the updated version of 'config' within the '_config' attribute
