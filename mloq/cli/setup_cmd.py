...
def welcome_message_docs():
    """Welcome message to be displayed during interactive documentation setup."""
    click.echo(
        "Welcome to the MLOQ {__version__} interactive setup utility.\nThis generates "
        "the necessary documentation for your new project.",
    )
    click.echo()
    click.echo(
        "Please enter values for the following settings (just press Enter "
...
def setup_docs(
    ...
    Create the necessary documentation of the new project (following
