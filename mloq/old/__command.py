...
from mloq.old.__api import dump_ledger as dl
...
class SetupCommand(Command):
    ...
    def interactive_config(self) -> DictConfig:
        """Generate the configuration of the project interactively."""
        from mloq.cli import generate_config_interactive

        return generate_config_interactive(self.config)

    def generate_config(self) -> DictConfig:
        """Generate the configuration of the project via a configuration file."""
        from mloq.old.config.__setup_generation import generate_config
    ...
    def write_templates(self) -> None:
        ...
        """
        from mloq.old.__api import setup_requirements, setup_root_files
        from mloq.old.__workflows import setup_workflow_template
    ...
    def create_directories(self) -> None:
        ...
        from mloq.old.__skeleton import (
...
class DocsCommand(Command):
    ...
    def create_directories(self) -> None:
        ...
        - Git repository
        """
        from mloq.old.__skeleton import create_docs_directories
